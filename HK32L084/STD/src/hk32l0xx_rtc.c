...
* @filename:  hk32l0xx_rtc.c
* @brief:     RTC init and functions configure
* @author:    AE Team
...
#define RTC_FLAGS_MASK          ((uint32_t)(RTC_FLAG_TSOVF | RTC_FLAG_TSF | RTC_FLAG_ALRAF | \
                                            ...
                                            RTC_FLAG_SHPF | RTC_FLAG_ALRBF|RTC_FLAG_WUTWF))
...
/** @defgroup RTC_Private_FunctionPrototypes  RTC Private FunctionPrototypes
  * @{
  */
