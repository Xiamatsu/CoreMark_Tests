...
#ifndef __HK32L0XX_DAC_H
#define __HK32L0XX_DAC_H
...
#define DAC_Trigger_T1_TRGO                ((uint32_t)0x00000004) /*!< TIM1 TRGO selected as external conversion trigger for DAC channel1 */
#define DAC_Trigger_T3_TRGO                ((uint32_t)0x0000000C) /*!< TIM3 TRGO selected as external conversion trigger for DAC channel1 */
#define DAC_Trigger_T3_CH3                 ((uint32_t)0x00000014) /*!< TIM3_CH3 TRGO selected as external conversion trigger for DAC channel1 */
#define DAC_Trigger_T15_TRGO               ((uint32_t)0x0000001C) /*!< TIM2 TRGO selected as external conversion trigger for DAC channel1 */
#define DAC_Trigger_T2_TRGO                ((uint32_t)0x00000024) /*!< TIM2 TRGO selected as external conversion trigger for DAC channel1 */
#define DAC_Trigger_CLU1_OUT               ((uint32_t)0x0000002C) /*!< CLU1_OUT  selected as external conversion trigger for DAC channel1 */
#define DAC_Trigger_Ext_IT9                ((uint32_t)0x00000034) /*!< EXTI Line9 event selected as external conversion trigger for DAC channels */
#define DAC_Trigger_Software               ((uint32_t)0x0000803C) /*!< Conversion started by software trigger for DAC channels */
