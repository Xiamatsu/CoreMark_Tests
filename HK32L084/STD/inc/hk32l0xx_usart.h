...
* @filename:  hk32l0xx_usart.h
* @brief:     Header for hk32l0xx_usart.h file.
* @author:    AE Team
*******************************************************************************/


/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __HK32L0XX_USART_H
#define __HK32L0XX_USART_H
...
/** @defgroup USART_Constants USART_Constants
  * @{
  */
